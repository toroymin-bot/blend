    ...
    <div className="h-full bg-gray-950 text-white overflow-y-auto">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <a
            href="#plans"
            className="inline-block px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl text-base transition-colors shadow-lg shadow-blue-900/40"
          >
            {t('billing.hero_cta')} →
          </a>
        </div>
        ...
        {/* Divider */}
        <div id="plans" className="border-t border-gray-800 mb-10" />

        {/* Header */}
        <div className="text-center mb-10">
          <h2 className="text-2xl font-bold mb-3">{t('billing.title')}</h2>
