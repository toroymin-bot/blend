...
// AppContentDesign3 — design3 전용 앱 셸 (/design3/[lang]/ 라우트 전용)
// app-content.tsx와 완전 독립. 이 파일을 자유롭게 수정해도 원본(/ko/qatest)에 영향 없음.
//
// 특정 뷰를 design3 전용으로 교체하려면:
//   1. 해당 뷰 파일을 복사 → e.g. src/modules/ui/about-view.design3.tsx
...
export default function AppContentDesign3() {
